...
/** */
export async function getStaticPathsBlogList({ paginate }: { paginate: PaginateFunction }) {
...
/** */
export async function getStaticPathsBlogCategory({ paginate }: { paginate: PaginateFunction }) {
...
/** */
export async function getStaticPathsBlogTag({ paginate }: { paginate: PaginateFunction }) {
